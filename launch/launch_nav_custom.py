...
def generate_launch_description():
    ...
    # Dynamic obstacles: run as an *external* Webots controller.
    # This avoids Webots searching for a controller directory (which can fail on WSL/Windows because WebotsLauncher
    # runs a temporary copy of the world outside the project tree).
